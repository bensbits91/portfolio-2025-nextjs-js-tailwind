...
export const projects = [
   {
      ...
      description:
         "My personal website, built in about a week... deployed using Vercel... custom components and theme... atomic component structure, including custom typography and layout... minimal dependencies... content stored as JSON inside the project (simple but inconvenient, considering moving data to my mongodb atlass)... a few li'l custom animations and transitions... images stored in cloudinary and optimized using next/image... videos stored using Vercel Blob storage... contact form sends email using nodemailer... api routes for contact form and image/video storage... Turbopack for faster page loads... dayjs for date formatting... Tailwind CSS for styling... Next.js for SSR and SSG... Vercel for deployment... Cloudinary for image and video storage... fun fun fun",
      motivation:
