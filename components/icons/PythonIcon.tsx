export default function PythonIcon({ dark = false }) {
   return (
      <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <path
            ...
            fill={dark ? 'currentColor' : 'url(#paint0_linear_87_8204)'}
         />
         <path
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill={
               dark
                  ? 'color-mix(in oklab, currentColor 60%, var(--bb-teal)'
                  : 'url(#paint1_linear_87_8204)'
            }
         />
      </svg>
   );
